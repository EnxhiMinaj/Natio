...
package com.junction.natio.azure.personalizer.implementation;

import com.junction.natio.azure.personalizer.PersonalizationClient;
...
public class PersonalizationClientImpl extends ServiceClient implements PersonalizationClient {
    ...
    interface PersonalizationClientService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: .PersonalizationClient reward" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: .PersonalizationClient rank" })
    ...
    public RankResponse rank(RankRequest personalizationRequest) {
        Observable<ServiceResponse<RankResponse>> result = rankWithServiceResponseAsync(personalizationRequest);

        return result.toBlocking().single().body();
    }
